...
export const CustomHeader = () => {
  return (
    <nav className="flex items-center  flex-wrap bg-blue p-6 h-8 ">
      <div className="flex items-center  flex-shrink-0 text-white mr-6">
        <span className="font-semibold text-xl tracking-tight ml-12  ">
          {" "}
          <svg
            xmlns="http://www.w3.org/2000/svg"
            class="h-6 w-6 -mt-2 ml-10"
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
            stroke-width="2"
        ...
        <span className="font-semibold text-base tracking-tight ml-2 -mt-3">
          0422 698 393
        </span>
      </div>
      ...
      <span className="font-normal text-base tracking-tight ml-2 -mt-5 text-white">
      👨‍💼My Account
      </span>
    </nav>
  );
